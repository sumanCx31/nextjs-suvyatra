...
import { 
  ...
  ShieldCheck, Edit3, Camera, Ticket 
} from "lucide-react";
        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 relative z-10">
            ...
            <div className="relative group">
              ...
              <button className="absolute bottom-2 right-2 p-2.5 bg-emerald-500 text-slate-950 rounded-xl shadow-lg hover:bg-emerald-400 transition-all active:scale-90">
                <Camera size={18} />
              </button>
            </div>
            ...
            <div className="text-center md:text-left space-y-2">
              <div className="flex flex-col md:flex-row items-center gap-3">
                ...
                <span className="px-4 py-1 bg-emerald-500/10 border border-emerald-500/20 text-emerald-500 text-[10px] font-black uppercase tracking-widest rounded-full">
                  Premium Traveler
                </span>
              </div>
              <p className="text-slate-400 font-medium max-w-md">
                Exploring the world with SuvYatra since {new Date(loggedInUser.createdAt).getFullYear() || "2026"}.
              </p>
              
              <div className="flex flex-wrap justify-center md:justify-start gap-4 pt-4">
                <Stat icon={<Ticket size={14}/>} label="Total Trips" value="24" />
